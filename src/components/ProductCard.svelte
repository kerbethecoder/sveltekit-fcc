...
<div class="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-14 lg:gap-20 relative text-base">
	...
	>
		<h4
			class="text-2xl sm:text-3xl md:text-4xl max-w-[1000px] font-medim relative after:absolute after:top-full after:left-0 after:w-1/5 after:h-1.5 after:mt-1 after:bg-slate-900"
		>
			<slot />
		</h4>
